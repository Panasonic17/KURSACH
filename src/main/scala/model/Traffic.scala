...
case class Traffic(origin: String, flight: String, course: Int, aircraft: String, callsign: String, registration: String, lat: Double, speed: Int, altitude: String, destination: String, lon: Double, time: Long,var originCity:String,destinationCity :String) {
...
object Traffic {
  ...
  def main(args: Array[String]): Unit = {
    val test = "{\n  \"origin\": \"ARN\",\n  \"flight\": \"SK637\",\n  \"course\": 216,\n  \"aircraft\": \"A20N\",\n  \"callsign\": \"SAS61Z\",\n  \"registration\": \"SE-ROB\",\n  \"lat\": 57.1295,\n  \"speed\": 437,\n  \"altitude\": 39025,\n  \"destination\": \"FRA\",\n  \"lon\": 14.4414,\n  \"time\": 1524748817\n}"
    val traffic=parceTraffic(test)
    traffic.originCity="sawa";
    print(traffic)
  }
}
